...
@tool
async def add_label(message_id: str, label_name: str, config: RunnableConfig = None) -> str:
    ...
    res = await gmail_tool.add_label(message_id=message_id, label_name=label_name)
